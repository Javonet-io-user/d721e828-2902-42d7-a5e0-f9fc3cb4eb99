...
public class Activation {
  ...
  private static String email = "lberwid@sdncenter.pl";
  private static String licenseKey = "Jm9a-Mr78-Hi5x-r4P5-x2SJ";
  ...
  public static void initializeJavonet() {
    if (!Javonet.isActivated()) {
      ...
      try {
        ...
        AddEmbeddedDllReference("RDPCrystalEDILibrary.UI.Winforms.dll");
